...
export const AUTH_EXPIRES_IN = process.env.AUTH_EXPIRES_IN ?? process.env.NEXT_PUBLIC_AUTH_EXPIRES_IN ?? '604800' // 7 days
// When true, prefer the configured AUTH_EXPIRES_IN over provider/res.expiresIn
export const AUTH_FORCE_EXPIRES_IN = (process.env.AUTH_FORCE_EXPIRES_IN || 'false').toLowerCase() === 'true'
