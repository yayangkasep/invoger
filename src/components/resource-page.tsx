        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex-1">
            <input
              ...
              className="w-full rounded-md border border-input bg-background px-4 h-9 text-sm shadow-sm"
            ...
            {toolbarActions.map((a, i) =>
              a.node ? (
                ...
                <Button
                  key={`${a.label}-${i}`}
                  size="sm"
                  variant={a.variant === "destructive" ? "destructive" : a.variant === "outline" ? "outline" : undefined}
                  onClick={a.onClick}
                >
