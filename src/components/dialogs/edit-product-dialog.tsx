...
export default function EditProductDialog({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      setLoading(true)
      const bodyPayload = { name: name.trim(), code: code.trim(), price: Number(cleaned || 0), Promotion: promotion ?? null }
  ...
  return (
    <BaseDialog
      ...
      trigger={trigger ?? <Button variant="outline"><IconEdit className="size-4" /> Edit</Button>}
      open={open}
