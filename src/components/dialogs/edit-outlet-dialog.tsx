...
export default function EditOutletDialog({
  outlet,
  onUpdate,
  open,
  onOpenChange,
  ...
  const [touched, setTouched] = React.useState<{ Name?: boolean; Code?: boolean }>({})
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      setLoading(true)
      const bodyPayload = { name: name.trim(), code: code.trim(), cashier: cashier || null, address: address || null, phone: phone || null }
