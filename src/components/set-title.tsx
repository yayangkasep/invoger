  ...
  useEffect(() => {
    try {
      ...
      try {
        ...
        const persisted = getCookie('invoger_theme') || (localStorage.getItem('invoger_theme') as string | null)
        // Prefer next-themes stored value (localStorage.theme) for light/dark mode decision.
        const nextTheme = (localStorage.getItem && localStorage.getItem('theme')) || null
