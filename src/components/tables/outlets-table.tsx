...
// columns are created inside the component so action handlers can access router and component state
...
export function OutletTable({ data: initialData, optimisticItems, loading: loadingProp }: { data?: Outlet[]; optimisticItems?: Outlet[]; loading?: boolean }) {
  ...
  const [deleteOpenId, setDeleteOpenId] = React.useState<string | null>(null) // stores identifier: uuid || id
